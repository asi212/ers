...
try:
    ...
    class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            if hideDocumentProblems == False:
                docDev_button = tk.Button(self, text="Document Problem",
    ...
    class CreateNew(tk.Frame):
        ...
        def __init__(self, parent, controller):
            tk.Frame.__init__(self, parent)
            self.controller = controller
            self.label = tk.Label(self, text="Leave High Temperature Empty is Hot-system")
            ...
            tempMed_label = tk.Label(self, text="Test Temp Intermediate")
    ...
    if hideDocumentProblems == False:
        class DocDev(tk.Frame):
            def __init__(self, parent, controller):
                ...
                self.save_button = tk.Button(self, text="Save", command=lambda: save(lauf_num))
          ...
          #  else:
           ...
           # print('=' + phigh_spec_val)
            ...
            try:
                ...
                messagebox.showwarning("Warning", "Pt100 data may be missing")
                Pt100_missing = True
